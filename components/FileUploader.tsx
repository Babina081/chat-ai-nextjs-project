...
const FileUploader = () => {
  ...
  const statusIcons: {
    ...
    [StatusText.UPLOADING]: (
      <RocketIcon className="w-20 h-20 text-indigo-300" />
    ),
    [StatusText.UPLOADED]: (
      <CheckCircleIcon className="w-20 h-20 text-indigo-300" />
    ),
    [StatusText.SAVING]: <SaveIcon className="w-20 h-20 text-indigo-300" />,
    [StatusText.GENERATING]: (
      <HammerIcon className="w-20 h-20 text-indigo-300" />
    ),
  };
      ...
      {!uploadInProgress && (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center">
            {isDragActive ? (
              <>
                <RocketIcon className="w-20 h-20 animate-ping text-indigo-700" />
